...
- `tools/preprocess_prompt.py` – compiles prompts using `config/prompt_config.yaml` and a template.
- `config/prompt_config.yaml` – defines available modules and their `evaluate_body` logic.
...
```bash
python3 tools/preprocess_prompt.py \
